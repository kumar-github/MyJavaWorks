...
import com.amphorainc.apps.tradeinsert.controller.TradeInsertApplicationController;
	...
	public void launchApplication()
	{
		...
		SwingUtilities.invokeLater(new Runnable()
		{
			...
			public void run()
			{
				...
				//tradeInsertMainView.showGUI();
				//tradeInsertMainView.load();
				//tradeInsertMainController.showGUI();
				tradeInsertMainController.authenticateAndShowGUI();
			}
		});
	}
	*/
	...
	public void run()
	{
		new TradeInsertApplicationController().launchApplication();
	}
}