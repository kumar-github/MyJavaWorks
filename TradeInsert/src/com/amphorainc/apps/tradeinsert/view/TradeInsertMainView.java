...
public class TradeInsertMainView extends JFrame
{
	...
	private JMenuItem menuitemInfoPanel;
	...
	private void createComponents()
	{
		...
		Icon infoIcon = new ImageIcon("D:\\MyDropbox\\Dropbox\\My Java Workspace\\TradeInsert\\resources\\icons\\info.png");
		menuitemInfoPanel = new JMenuItem("Info Panel", infoIcon);
		
		Icon prefIcon = new ImageIcon("D:\\MyDropbox\\Dropbox\\My Java Workspace\\TradeInsert\\resources\\icons\\pref.png");
		menuitemPreferences = new JMenuItem("Preferences", prefIcon);
		
		Icon exitIcon = new ImageIcon("D:\\MyDropbox\\Dropbox\\My Java Workspace\\TradeInsert\\resources\\icons\\exit.png");
		menuitemExit = new JMenuItem("Exit", exitIcon);
		
		menuFile.add(menuitemInfoPanel);
		...
		//lblLog.setFont(lblLog.getFont().deriveFont(Font.BOLD));
		lblLog.setFont(new Font("Microsoft Sans Serif", Font.BOLD, 12));
	...
	public JMenuItem getInfoPanelMenuItem()
	{
		return mnuitemInfoPanel;
	}*/
	...
	public JButton getLoadTradesButton()
	{
		return btnLoadTrades;
	}
